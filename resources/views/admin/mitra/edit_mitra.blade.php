            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/mitra">Daftar Mitra</a> </li>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" class="form-control" id="basicInput" placeholder="Nama Mitra" value ="{{$data['nama'] }}" required >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <button  type="reset" class="btn btn-light-secondary me-1 mb-1"> <a href="/mitra">Back </a> </button>
                          </div>
                          </div>
