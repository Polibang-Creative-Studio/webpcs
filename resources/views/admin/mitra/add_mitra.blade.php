            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="/mitra">Daftar Mitra</a></li>
...
<!-- batas -->
            <form action="/add-mitra" method="post" enctype="multipart/form-data">   
            {{ csrf_field() }}
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" class="form-control" id="basicInput" placeholder="Nama Mitra" required>
                        </div>
                        <div class="form-group">
                            <label for="basicInput">Logo Mitra</label>
